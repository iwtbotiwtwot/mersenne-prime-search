# SLCMP03 frozen candidate export

`SLCMP03` is the public post-run name for completed MP-S10-R03 over
`143300000 < p <= 143400000`.

**The test result suggests the concept is possible.**

The source run screened 5,347 prime exponents, found
1,298 exact structural factors, routed
2,182 further recorded-factor assignments,
executed 17,913,865 deep-shell opportunities,
and completed frozen status triage to this 1,225-row candidate roster.
