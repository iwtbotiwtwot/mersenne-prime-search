# SLCMP04 frozen candidate export

`SLCMP04` is the public post-run name for completed MP-S10-R04 over
`143400000 < p <= 143500000`.

**The test result suggests the concept is possible.**

The source run screened 5,332 prime exponents, found
1,301 exact structural factors, routed
2,108 further recorded-factor assignments,
executed 18,451,185 deep-shell opportunities,
and completed frozen status triage to this 1,244-row candidate roster.
